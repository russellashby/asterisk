...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private func setupMenu() {
        ...
        addItem(editMenu, "Cut", #selector(EditorView.wsCut(_:)), "x")
        addItem(editMenu, "Copy", #selector(EditorView.wsCopy(_:)), "c")
        addItem(editMenu, "Paste", #selector(EditorView.wsPaste(_:)), "v")
        editMenu.addItem(.separator())
